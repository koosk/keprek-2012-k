%a dart beagyazott fuggvenye, amely a kulonbozo valtoztatott vetuleteket
%szamolja
function [x_dart t_dart time_dart x t time] = DART_uncertain_embedded(p, R, W, angles, C, FREE_PROBABILITY, LAMBDA, numIter, pictureSize)
...
%fprintf('VEGE EGY CIKLUSNAK, uncertain_inside');       
        if adaptiveCounter==0
